module.exports = {
    ...
    async execute(client, message, args, Discord) {
        ...
        const hetheyRole = message.guild.roles.cache.find(
            (role) => role.name === 'he/they',
        );
        const shetheyRole = message.guild.roles.cache.find(
            (role) => role.name === 'she/they',
        );
        const hehimRole = message.guild.roles.cache.find(
            (role) => role.name === 'he/him',
        );
        const sheherRole = message.guild.roles.cache.find(
            (role) => role.name === 'she/her',
        );
        const theythemRole = message.guild.roles.cache.find(
            (role) => role.name === 'they/them',
        );
        const xexemRole = message.guild.roles.cache.find(
            (role) => role.name === 'xe/xem',
        );
        ...
        let embed = new Discord.MessageEmbed()
            ...
            .setDescription(
                `I hope this goes without saying but don't abuse these\n\n` +
            ...
            if (reaction.message.channel.id == channel) {
                if (reaction.emoji.name == hetheyEmoji) {
                    await reaction.message.guild.members.cache
                        .get(user.id)
                        .roles.add(hetheyRole);
                }
                if (reaction.emoji.name == shetheyEmoji) {
                    await reaction.message.guild.members.cache
                        .get(user.id)
                        .roles.add(shetheyRole);
                }
                ...
                if (reaction.emoji.name == sheherEmoji) {
                    await reaction.message.guild.members.cache
                        .get(user.id)
                        .roles.add(sheherRole);
                }
                if (reaction.emoji.name == theythemEmoji) {
                    await reaction.message.guild.members.cache
                        .get(user.id)
                        .roles.add(theythemRole);
                }
        ...
        client.on('messageReactionRemove', async (reaction, user) => {
            ...
            if (reaction.message.channel.id == channel) {
                if (reaction.emoji.name == hetheyEmoji) {
                    await reaction.message.guild.members.cache
                        .get(user.id)
                        .roles.remove(hetheyRole);
                }
                if (reaction.emoji.name == shetheyEmoji) {
                    await reaction.message.guild.members.cache
                        .get(user.id)
                        .roles.remove(shetheyRole);
                }
                if (reaction.emoji.name == hehimEmoji) {
                    await reaction.message.guild.members.cache
                        .get(user.id)
                        .roles.remove(hehimRole);
                }
                if (reaction.emoji.name == sheherEmoji) {
                    await reaction.message.guild.members.cache
                        .get(user.id)
                        .roles.remove(sheherRole);
                }
                if (reaction.emoji.name == theythemEmoji) {
                    await reaction.message.guild.members.cache
                        .get(user.id)
                        .roles.remove(theythemRole);
                }
                if (reaction.emoji.name == xexemEmoji) {
                    await reaction.message.guild.members.cache
                        .get(user.id)
                        .roles.remove(xexemRole);
                }
            }
        });
    },
